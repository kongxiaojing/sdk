    ...
    public static class GameObjects
    {
        ...
        internal static void Initialize()
        {
            ...
            Events.OnLoad += (sender, eventArgs) =>
            {
                    ...
                    ObjectManager.Get<Obj_AI_Minion>()
                        .Where(
                            o =>
                                ...
                                !o.CharData.BaseSkinName.ToLower().Contains("trinket") && !o.CharData.BaseSkinName.Equals("gangplankbarrel")));
                ...
                WardsList.AddRange(
                    ObjectManager.Get<Obj_AI_Minion>()
                        .Where(o => o.CharData.BaseSkinName.ToLower().Contains("ward") || o.CharData.BaseSkinName.ToLower().Contains("trinket")));
        ...
        private static void OnCreate(GameObject sender, EventArgs args)
        {
            ...
            if (minion != null)
            {
                ...
                {
                    if (minion.CharData.BaseSkinName.ToLower().Contains("ward") || minion.CharData.BaseSkinName.ToLower().Contains("trinket"))
                    {
