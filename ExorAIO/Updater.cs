            ...
            Task.Factory.StartNew(
                () =>
                {
                    try
                    {
                        ...
                        {
                            var rawVersion = 
                                c.DownloadString("https://raw.githubusercontent.com/nabbhacker/SDKExoryREPO/master/ExorAIO/Properties/AssemblyInfo.cs");
                    ...
                    {
                        Console.WriteLine(e);
                        Game.PrintChat("font color=\"#FFF280\">Exception thrown at [SDK]ExorAIO.Updater, make a screenshot of the console and send it to Exory.");
                    }
                }
            );
        }
