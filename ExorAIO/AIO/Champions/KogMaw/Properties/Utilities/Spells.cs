...
namespace ExorAIO.Champions.KogMaw
{
    ...
    internal class Spells
    {
        ...
        public static void Initialize()
        {
            ...
            Vars.W = new Spell(
                SpellSlot.W, Vars.AARange + (60f + 30f * GameObjects.Player.Spellbook.GetSpell(SpellSlot.W).Level));
            ...
            Vars.R.SetSkillshot(1.2f, 75f, 12000f, false, SkillshotType.SkillshotCircle);
        }
    }
}