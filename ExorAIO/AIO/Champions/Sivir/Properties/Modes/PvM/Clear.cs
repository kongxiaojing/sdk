    ...
    internal partial class Logics
    {
        ...
        public static void Clear(Obj_AI_Base sender, GameObjectProcessSpellCastEventArgs args)
        {
                ...
                Vars.Menu["spells"]["w"]["clear"].GetValue<MenuBool>().Value)
            {
                ...
                /// </summary>
                if (Vars.Q.GetLineFarmLocation(Targets.Minions, Vars.Q.Width).MinionsHit >= 4)
                {
                    Vars.W.Cast();
                }
                ...
                else
                {
                                        ...
                                        (Vector2)
                                            Vars.Q.GetPrediction(
                                                GameObjects.EnemyHeroes.FirstOrDefault(
                                                    t => !Bools.HasAnyImmunity(t) && t.IsValidTarget(Vars.Q.Range)))
                                                .CastPosition))
                        {
                    ...
                    /// </summary>
                        ...
                        !GameObjects.EnemyHeroes.Any(
                            t => !Bools.HasAnyImmunity(t) && t.IsValidTarget(Vars.Q.Range + 100f)))
                    {
                        if (Vars.Q.GetLineFarmLocation(Targets.Minions, Vars.Q.Width).MinionsHit >= 4)
                        {
                            Vars.Q.Cast(Vars.Q.GetLineFarmLocation(Targets.Minions, Vars.Q.Width).Position);
