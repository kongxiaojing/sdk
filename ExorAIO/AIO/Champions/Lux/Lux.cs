...
namespace ExorAIO.Champions.Lux
{
    ...
    internal class Lux
    {
        ...
        {
            if (obj.IsValid && obj.Name.Equals("LuxLightstrike_tar_"))
            {
                EMissile = obj;
            }
        }
        ...
        {
            if (obj.IsValid && obj.Name.Contains("LuxLightstrike_tar_"))
            {
                EMissile = null;
            }
        }
        ...
        {
            if (Vars.Q.IsReady() && args.IsDirectedToPlayer && !Bools.HasAnyImmunity(args.Sender) &&
